...
const LABEL_WIDTH = 120; // Width for the fixed label column (sync with CSS)
...
function renderTimeline() {
    ...
    // Use a fixed height or calculate based on SVG content
    const containerHeight = `${totalSvgHeight}px`;
    // wrapper.style.height = containerHeight; // Might cause issues if content overflows vertically
    labelContainer.style.height = containerHeight;
